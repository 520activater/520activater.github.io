...
![图片1]([/images/blog-posts/KV Cache1.png](https://github.com/520activater/520activater.github.io/blob/master/images/blog-posts/KV%20Cache1.png)


9. 将最终输出的词元传输到CPU，并进行逆词元化（detokenization）以获取生成的文本（见下图）
![图片2](https://github.com/520activater/520activater.github.io/blob/master/images/blog-posts/KV%20Cache2.png)
...
- **键（Key, K）**
- **值（Value, V）**
计算注意力得分的公式是：$$Attention = softmax(\frac{QK^T}{\sqrt(d_k)}V) $$
...
![图片3](https://github.com/520activater/520activater.github.io/blob/master/images/blog-posts/KV%20Cache3.png)
...
(https://github.com/520activater/520activater.github.io/blob/master/images/blog-posts/KV%20Cache4.png)
